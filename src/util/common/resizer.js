...
import OrthographicCamera from "@/util/common/orthographicCamera";
...
export default class Resizer extends Component{
    ...
    get aspect() {
        return this.base.container.offsetWidth / this.base.container.offsetHeight;
    }
    resizeRenderer(renderer) {
        renderer.setSize(this.base.container.offsetWidth, this.base.container.offsetHeight);
        renderer.setPixelRatio(Math.min(2, window.devicePixelRatio));
    }
    resizeComposer(composer) {
        composer.setSize(this.base.container.offsetWidth, this.base.container.offsetHeight);
