...
import backgeoundVertex from '@/views/example/aurora/glsl/backgeoundVertex.glsl'
import backgroundFragment from '@/views/example/aurora/glsl/backgroundFragment.glsl'

import treeVertex from '@/views/example/aurora/glsl/treeVertex.glsl'
import treeFragment from '@/views/example/aurora/glsl/treeFragment.glsl'

import mountainVertex from '@/views/example/aurora/glsl/mountainVertex.glsl'
import mountainFragment from '@/views/example/aurora/glsl/mountainFragment.glsl'
