...
import vertex from '@/views/example/ablate/glsl/vertex.glsl'
import transition1 from '@/views/example/ablate/glsl/transition1.glsl'
import transition2 from '@/views/example/ablate/glsl/transition2.glsl'
import transition3 from '@/views/example/ablate/glsl/transition3.glsl'
import transition4 from '@/views/example/ablate/glsl/transition4.glsl'
import transition5 from '@/views/example/ablate/glsl/transition5.glsl'
import transition6 from '@/views/example/ablate/glsl/transition6.glsl'
import transition7 from '@/views/example/ablate/glsl/transition7.glsl'
import transition8 from '@/views/example/ablate/glsl/transition8.glsl'
import transition9 from '@/views/example/ablate/glsl/transition9.glsl'
import transition10 from '@/views/example/ablate/glsl/transition10.glsl'
import transition11 from '@/views/example/ablate/glsl/transition11.glsl'
import transition12 from '@/views/example/ablate/glsl/transition12.glsl'
