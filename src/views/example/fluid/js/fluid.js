...
import rawVert from '@/views/example/fluid/glsl/rawVert.glsl'
import rawFrag from '@/views/example/fluid/glsl/rawFrag.glsl'
import blurFrag from '@/views/example/fluid/glsl/blurFrag.glsl'
import blitFrag from "@/views/example/fluid/glsl/blitFrag.glsl";
import screenPaintFrag from "@/views/example/fluid/glsl/screenPaintFrag.glsl";
