...
import dynamicEnvVertexShader from "@/views/example/su7/DynamicEnv/vert.glsl";
import dynamicEnvFragmentShader from "@/views/example/su7/DynamicEnv/frag.glsl";
import reflecFloorVertexShader from "@/views/example/su7/ReflecFloor/vert.glsl";
import reflecFloorFragmentShader from "@/views/example/su7/ReflecFloor/frag.glsl";
import speedUpVertexShader from "@/views/example/su7/Speedup/vert.glsl";
import speedUpFragmentShader from "@/views/example/su7/Speedup/frag.glsl";
