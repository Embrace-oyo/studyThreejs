...
import gateVertexShader from '@/views/example/common/neon/glsl/gateVertexShader.glsl';
import gateFragmentShader from '@/views/example/common/neon/glsl/gateFragmentShader.glsl'

import roadVertexShader from '@/views/example/common/neon/glsl/roadVertexShader.glsl';
import roadFragmentShader from '@/views/example/common/neon/glsl/roadFragmentShader.glsl'

import ceilingVertexShader from '@/views/example/common/neon/glsl/ceilingVertexShader.glsl';
import ceilingFragmentShader from '@/views/example/common/neon/glsl/ceilingFragmentShader.glsl'

import wallVertexShader from '@/views/example/common/neon/glsl/wallVertexShader.glsl';
import wallFragmentShader from '@/views/example/common/neon/glsl/wallFragmentShader.glsl'
