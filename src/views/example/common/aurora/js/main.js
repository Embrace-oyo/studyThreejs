...
import backgeoundVertex from '@/views/example/common/aurora/glsl/backgeoundVertex.glsl'
import backgroundFragment from '@/views/example/common/aurora/glsl/backgroundFragment.glsl'

import treeVertex from '@/views/example/common/aurora/glsl/treeVertex.glsl'
import treeFragment from '@/views/example/common/aurora/glsl/treeFragment.glsl'

import mountainVertex from '@/views/example/common/aurora/glsl/mountainVertex.glsl'
import mountainFragment from '@/views/example/common/aurora/glsl/mountainFragment.glsl'
