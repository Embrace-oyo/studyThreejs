...
import PoolWater from "@/views/pages/water/js/index";
...
onMounted(() => {
  ...
  world = new PoolWater({
    parent: document.querySelector('.water'),
...
onUnmounted(() => {
  world.destroy()
  world = null
  console.info("%c泳池-销毁😁", "color:#fff;background-color:red");
})
</script>
