...
import Ocean from "@/views/pages/ocean/js/index";
...
onMounted(() => {
  ...
  world = new Ocean({
    parent: document.querySelector('.ocean'),
...
onUnmounted(() => {
  world.destroy()
  world = null
  console.info("%c海洋-销毁😁", "color:#fff;background-color:red");
})
</script>
