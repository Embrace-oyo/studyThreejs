/**
 * justThreeJs foregroundLeavesCreate.js
 * @author kongjianqiu
 * @description
 * @created 2025/4/1 14:25:47
 */
import * as THREE from "three";
import {FullScreenQuad} from "three/addons/postprocessing/Pass.js";

// glsl
import vertex from '@/views/pages/abeto/glsl/foregroundLeaves/vertex.glsl'
import fragment from '@/views/pages/abeto/glsl/foregroundLeaves/fragment.glsl'
import vertex2 from '@/views/pages/abeto/glsl/foregroundLeaves/vertex2.glsl'
import fragment2 from '@/views/pages/abeto/glsl/foregroundLeaves/fragment2.glsl'
...
export default class ForegroundLeavesCreate {
    constructor(base, t = {}) {
        this.base = base;
