...
import gateVertexShader from '@/views/pages/neon/glsl/gateVertexShader.glsl';
import gateFragmentShader from '@/views/pages/neon/glsl/gateFragmentShader.glsl'

import roadVertexShader from '@/views/pages/neon/glsl/roadVertexShader.glsl';
import roadFragmentShader from '@/views/pages/neon/glsl/roadFragmentShader.glsl'

import ceilingVertexShader from '@/views/pages/neon/glsl/ceilingVertexShader.glsl';
import ceilingFragmentShader from '@/views/pages/neon/glsl/ceilingFragmentShader.glsl'

import wallVertexShader from '@/views/pages/neon/glsl/wallVertexShader.glsl';
import wallFragmentShader from '@/views/pages/neon/glsl/wallFragmentShader.glsl'
