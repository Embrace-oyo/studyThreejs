...
class FboHelper {
    ...
    init(e, t) {
        this.renderer = e, this.floatType = t, this.isWebGL2 = this.renderer.capabilities.isWebGL2, this._scene = new Scene, this._camera = new Camera, this._camera.position.z = 1, this.triGeom = new BufferGeometry, this.triGeom.setAttribute("position", new BufferAttribute(new Float32Array([-1, -1, 0, 4, -1, 0, -1, 4, 0]), 3)), this.quadGeom = new PlaneGeometry(2, 2), this._tri = new Mesh(this.triGeom), this._tri.frustumCulled = !1, this._scene.add(this._tri),
        ...
        this.vertexShader = this.isWebGL2 ? this.precisionPrefix2 + blitVert : this.precisionPrefix + blitVert
        ...
        r.translate(.5, -.5, 0), this._debugMaterial = this.createRawShaderMaterial({
            uniforms: {
            ...
            blending: NoBlending,
            glslVersion: this.isWebGL2 ? GLSL3 : GLSL1
        }), this._debugMesh = new Mesh(r, this._debugMaterial), this._debugScene = new Scene, this._debugScene.frustumCulled = !1, this._debugScene.add(this._debugMesh)
    }
    ...
    debugTo(e, t, r, n, a) {
        ...
        t = t || e.width || e.image.width, r = r || e.height || e.image.height, n = n || 0, a = a || 0;
        const l = this.renderer.getSize(new Vector2);
        n = n / l.width * 2 - 1, a = 1 - a / l.height * 2, t = t / l.width * 2, r = r / l.height * 2, this._debugMaterial.uniforms.u_texture.value = e, this._debugMaterial.uniforms.u_transform.value.set(n, a, t, r);
...
`
    ...
    clearColor(e, t, r, n, a) {
        this.clearMaterial && (this.clearMaterial.uniforms.u_color.value.set(e, t, r, n), this.render(this.clearMaterial, a))
    }
    ...
    createRawShaderMaterial(e) {
        e = Object.assign({
            ...
            fragmentShader: blitFrag,
            derivatives: !1
        }, e), e.vertexShader = (e.vertexShaderPrefix ? e.vertexShaderPrefix : e.derivatives ? this.vertexPrefix : this.vertexPrefix) + e.vertexShader, e.fragmentShader = (e.fragmentShaderPrefix ? e.fragmentShaderPrefix : e.derivatives ? this.fragmentPrefix : this.fragmentPrefix) + e.fragmentShader, delete e.vertexShaderPrefix, delete e.fragmentShaderPrefix, delete e.derivatives, e.glslVersion = this.isWebGL2 ? GLSL3 : GLSL1;
        let t = new RawShaderMaterial(e);
        return taskManager.add(t), t
    }

    createDataTexture(e, t, r, n = !1, a = !0) {
        let l = new DataTexture(e, t, r, RGBAFormat, n ? FloatType : UnsignedByteType, UVMapping, ClampToEdgeWrapping, ClampToEdgeWrapping, a ? NearestFilter : LinearFilter, a ? NearestFilter : LinearFilter, 0);
    ...
    createRenderTarget(e, t, r = !1, n = !1, a = 0) {
        return new WebGLRenderTarget(e, t, {
            ...
            depthBuffer: !1,
            stencilBuffer: !1,
            samples: browser$1.isSupportMSAA ? a : 0
        })
    }
    ...
    clearMultisampleRenderTargetState(e) {
        if (e = e || this.renderer.getRenderTarget(), e && e.samples > 0) {
            ...
            e.depthBuffer && (l |= r.DEPTH_BUFFER_BIT), e.stencilBuffer && (l |= r.STENCIL_BUFFER_BIT), r.blitFramebuffer(0, 0, n, a, 0, 0, n, a, l, r.NEAREST), r.bindFramebuffer(r.FRAMEBUFFER, t.__webglMultisampledFramebuffer)
        }
    }
}
