...
import Ripples from "@/views/pages/ripples/js/index";
...
onMounted(() => {
  ...
  world = new Ripples({
    parent: document.querySelector('.ripples'),
...
onUnmounted(() => {
  world.destroy()
  world = null
  console.info("%c涟漪-销毁😁", "color:#fff;background-color:red");
})
</script>
