...
import Ring from '@/views/pages/ring/js/index'
...
onMounted(() => {
  ...
  world = new Ring({
    parent: document.querySelector('.ring'),
...
onUnmounted(() => {
  world.destroy()
  world = null
  console.info("%c扩散光环-销毁😁", "color:#fff;background-color:red");
})
</script>
