...
export default class SpaceDiscover {
    constructor(config) {
    ...
    assetsInit() {
        ...
        this.loader.load(filePath('space_discoverer.glb'), (gltf) => {
        ...
        this.loader.load(filePath('space_discoverer_wheel.glb'), (gltf) => {
    ...
    groundInit() {
        ...
        image.src = filePath('terrain1.png')
        image.onload = () => {
            const width = 128;
            const height = 128;
