...
export default class Properties {
    ...
    constructor(base) {
        this.base = base;
        let computedStyle = getComputedStyle(this.base.target);
        this.offWhiteColorHex = computedStyle.getPropertyValue("--color-off-white").trim();
        this.blackColorHex = computedStyle.getPropertyValue("--color-black").trim();
        this.blueColorHex = computedStyle.getPropertyValue("--color-blue").trim();
        this.bgColorHex = computedStyle.getPropertyValue("--color-off-white").trim();
        this.loader = this.base.quickLoader;
        this.onFirstClicked = new MinSignal;
        this.changeCamera = new MinSignal;
        this.defaults = {
            ...
            upscalerAmount: 1,
            upscalerSharpness: 1,
            isSmaaEnabled: !this.base.settings.USE_HD
        };
    }
