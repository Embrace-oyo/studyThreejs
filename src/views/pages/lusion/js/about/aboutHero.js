...
import AboutHeroLight from "@/views/pages/lusion/js/about/aboutHeroLight.js";
import AboutHeroParticlesSimulation from "@/views/pages/lusion/js/about/aboutHeroParticlesSimulation.js";
import AboutHeroParticles from "@/views/pages/lusion/js/about/aboutHeroParticles.js";
import AboutHeroLightField from "@/views/pages/lusion/js/about/aboutHeroLightField.js";
import AboutHeroScatter from "@/views/pages/lusion/js/about/aboutHeroScatter.js";
import AboutHeroRocks from "@/views/pages/lusion/js/about/aboutHeroRocks";
import AboutHeroGround from "@/views/pages/lusion/js/about/aboutHeroGround";
import AboutHeroPerson from "@/views/pages/lusion/js/about/aboutHeroPerson";
...
export default class AboutHero extends Stage3D {
    ...
    resize(w, h) {
        // aboutHeroFog.resize(w, h);
        // aboutHeroHalo.resize(w, h);
        // aboutHeroFaces.resize(w, h);
    }
