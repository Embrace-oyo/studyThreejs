...
import Animator from '@/views/shaderStudy/glsl/page8/init/animator'
import Clock from '@/views/shaderStudy/glsl/page8/init/clock'
import IMouse from '@/views/shaderStudy/glsl/page8/init/iMouse'
import Resizer from '@/views/shaderStudy/glsl/page8/init/resizer'
import Keyboard from '@/views/shaderStudy/glsl/page8/init/keyboard'
/**
